! function(e) {
    ...
    var t = {
        root: e(":root"),
        init: function() {
            t.BgImg(), t.imgToSVG(), t.navigation__resize(), t.navigation__closer(), t.scrollToNextSection(), t.about__parallax(), t.tabs(), t.progress(), t.isotope(), t.testimonial(), t.loadBlogPosts(), t.contactForm(), t.movingPlaceholder(), t.cvHover(), t.magnific(), t.wow(), t.scrollToAnchor(), t.colorScheme(), t.mobileMenuOpener()
        },
        mobileMenuOpener: function() {
            e(".rewall_fn_mobilemenu_wrap .hamburger").on("click", function() {
                var t = e(this),
                    n = e(".rewall_fn_mobilemenu_wrap .mobilemenu");
        ...
        magnificItems: function(t) {
            ...
            return t.find(".zoom").each(function() {
                ...
                return 0 === e.filter(e => e.src === t.src && e.title === t.title).length && e.push(t), e
            }, [])
        },
        cvHover: function() {
        ...
        movingPlaceholder: function() {
            e(".rewall_fn_contact .input_wrapper").each(function() {
                var t = e(this),
                    n = t.find("input, textarea");
                "" === n.val() && t.removeClass("active"), n.on("focus", function() {
                    t.addClass("active")
                }).on("blur", function() {
        ...
        contactForm: function() {
            e("#send_message").on("click", function() {
                var t = e(".rewall_fn_contact .contact_form"),
                    n = e("#name").val(),
                    o = e("#email").val(),
                    a = e("#message").val(),
                    s = e("#phone").val(),
                    ...
                    r = i.data("success"),
                    c = t.data("email");
                return i.empty(), "" === n || "" === o || "" === a || "" === c || "" === s ? e(".empty_notice").slideDown(500).delay(2e3).slideUp(500) : e.post("modal/contact.php", {
                    ajax_name: n,
                    ajax_email: o,
                    ajax_emailto: c,
                    ajax_message: a,
                    ...
                    i.append(e), i.find(".contact_error").length ? i.slideDown(500).delay(2e3).slideUp(500) : (i.append("<span class='contact_success'>" + r + "</span>"), i.slideDown(500).delay(4e3).slideUp(500)), "" === e && t[0].reset()
                }), !1
            })
        },
        loadBlogPosts: function() {
            e(".blog_list .load_more a").on("mousedown", function() {
                var t = e(this),
                    n = t.find(".text");
                if (t.hasClass("done")) return t.addClass("hold"), n.text(t.attr("data-no")), !1
            }).on("mouseup", function() {
                var t = e(this),
                    n = t.find(".text");
                if (t.hasClass("done")) return t.removeClass("hold"), n.text(t.attr("data-done")), !1
            }).on("mouseleave", function() {
                var t = e(this),
                    n = t.find(".text");
                if (t.hasClass("done")) return t.removeClass("hold"), n.text(t.attr("data-done")), !1
                ...
                var n = e(this),
                    o = n.find(".text");
                if (n.hasClass("loading") || n.hasClass("done")) return !1;
                n.addClass("loading");
                for (var a, s = n.attr("data-loading").split(""), i = "", r = s.length, c = 2e3 / r, l = 0; l < r; l++) i += s[l], t.search_placeholder(o, i, l, c);
                return a = setInterval(function() {
                    i = "";
                    for (var e = 0; e < r; e++) i += s[e], t.search_placeholder(o, i, e, c)
                }, c * r), setTimeout(function() {
                    clearInterval(a), n.removeClass("loading")
                }, c * r * 1.9), setTimeout(function() {
                    n.closest(".blog_list").find(".be_animated").each(function(t, n) {
                        setTimeout(function() {
                            e(n).addClass("fadeInTop done")
                        }, 100 * t)
                    }), n.addClass("done"), o.text(n.attr("data-done"))
                }, c * r * 2), !1
            })
        },
        ...
        testimonial: function() {
            e(".fn_cs_testimonials .owl-carousel").each(function() {
                ...
                t.owlCarousel({
                    ...
                    items: 1,
                    dots: !1
                }), t.trigger("refresh.owl.carousel"), t.on("changed.owl.carousel", function() {
        ...
        recallProgress: function(e) {
            e.find(".progress_bg").css({
                ...
                right: "100%"
            }), e.find(".progress_item").removeClass("open"), t.progress()
        },
        tabs: function() {
            e(".fn_cs_tabs .tab_header a").off().on("click", function() {
                ...
                return !o.hasClass("active") && (o.siblings().removeClass("active"), a.find(".tab_content").children().removeClass("active"), o.addClass("active"), e(n.attr("href")).addClass("active"), t.recallProgress(a), !1)
            })
        },
        ...
        scrollToNextSection: function() {
            ...
            e(".fn__next_section a").on("click", function() {
                ...
                return 1 === ++t ? (n = setTimeout(function() {
                    a = o.next().offset().top, e("html, body").animate({
                        scrollTop: a - 40
                    }, 700), t = 0
                }, 300), !1) : (clearTimeout(n), o.addClass("reverse"), setTimeout(function() {
                    o.removeClass("reverse")
                }, 1e3), setTimeout(function() {
                    a = o.prev().offset().top, e("html, body").animate({
                        scrollTop: a - 40
                    }, 700)
                }, 300), t = 0, !1)
        ...
        navigation__closer: function() {
            var n = e(".rewall_fn_wrapper_all");
            e(".rewall_fn_sidebar .nav__button").off().on("click", function() {
                return n.hasClass("sidebar-closed") ? n.removeClass("sidebar-closed") : n.addClass("sidebar-closed"), setTimeout(function() {
                    t.isotope(), t.testimonial()
                }, 500), !1
            })
        },
        navigation__resize: function() {
            var n = !1,
                o = e(".rewall_fn_sidebar"),
                a = e(".rewall_fn_content"),
                s = o.find(".nav_line"),
                i = o.data("max"),
                r = o.data("min"),
                c = e("body"),
            ...
            s.on("mousedown", function(e) {
                n = !0, e.clientX, c.addClass("sidebar-resize")
            }), e(document).on("mousemove", function(e) {
                var t = e.clientX;
                !n || t > i || t < r || (o.css("width", t), a.css("padding-left", t), l.html(t + "px"))
            }).on("mouseup", function() {
                n = !1, c.removeClass("sidebar-resize"), t.testimonial(), t.isotope()
            })
        },
        imgToSVG: function() {
...
}(jQuery), jQuery(".anchor_nav").onePageNav();
